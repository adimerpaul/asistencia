...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/asignacionesFind/{id}', [App\Http\Controllers\AsignacionController::class, 'asignacionesFind']);//    Route::delete('/asignaciones/{asignacion}', [App\Http\Controllers\AsignacionController::class, 'destroy']);
